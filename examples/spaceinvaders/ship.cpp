...
void Ship::initializeGL(GLuint program) {
  ...
  std::array<glm::vec2, 24> positions{
      // Ship body
      glm::vec2{-0.0f, -12.0f}, glm::vec2{-16.0f, +02.5f},
      glm::vec2{-16.0f, -12.5f}, glm::vec2{-11.7f, -07.5f},
      glm::vec2{-05.3f, -12.5f}, glm::vec2{-00.0f, -07.5f}, 
      glm::vec2{+05.3f, -12.5f}, glm::vec2{+11.7f, -07.5f}, 
      glm::vec2{+16.0f, -12.5f}, glm::vec2{+16.0f, +02.5f},
